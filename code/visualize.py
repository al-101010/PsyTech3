...
print_timetable_for_student('../data/test_output.csv', 'Yanick Abbing')
obtain_course_schedule('../data/test_output.csv', 'Software engineering')
show_activity_heatmap('../data/test_output.csv')
