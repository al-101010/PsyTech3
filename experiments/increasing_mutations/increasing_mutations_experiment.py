...
def increasing_mutations_all_averages(schedule, nr_climbers: int =30, nr_iterations: int =20000):
    ...
    for i in range(nr_climbers):
        ...
        get_output(climber.schedule.students, dir_path+f'/increasing_mutations{i + 1}_output.csv')
...
def increasing_mutations_ratios_plot(nr_climbers: int =30, nr_iterations: int =20000):
    '''
