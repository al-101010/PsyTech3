...
print_timetable_for_student('data/tested_hillclimber_output.csv', 'Steijn Ooijen')
# obtain_course_schedule('data/tested_hillclimber_output.csv', 'Software engineering')
# show_activity_heatmap('data/tested_hillclimber_output.csv')
obtain_room_schedule('data/tested_hillclimber_output.csv', 'A1.08')